...
public class HitShrewView extends View{
  ...
  static HitShrewView self;
	...
	public HitShrewView(Context context) 
	{
		super(context);
		self = this;
		HitShrewView.this.postDelayed(flush80ms, 80);
		HitShrewView.this.postDelayed(flush1000ms, 1000);
	}
	...
	Runnable flush80ms = new Runnable(){
		public void run(){
		  HitShrewView.this.invalidate();
		  HitShrewView.this.postDelayed(this, 100);
		}
	};
